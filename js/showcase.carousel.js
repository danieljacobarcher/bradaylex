$(document).ready(function(){ 
  ...
  $('#button_products_kerian').click(function(){
    ...
    var pagination = '5'; /* NUMBER OF SCREENSHOTS FOR PAGINATION */
    ...
    /* YOUR SCREENSHOTS */
    $('#showcase').html('<img id="product_1" src="images/products/kerian/null.jpg" alt="Image 1"><img id="product_2" src="images/products/kerian/null.jpg" alt="Image 2"><img id="product_3" src="images/products/kerian/null.jpg" alt="Image 3"><img id="product_4" src="images/products/kerian/null.jpg" alt="Image 4"><img id="product_5" src="images/products/kerian/null.jpg" alt="Image 5">');
    /* DESCRIPTION */
    $('.content_showcase').html('<p>This is Photoshop\'s version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. <br>Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.</p><p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc.</p>');
    /* THE PAGINATION */
    $('#nav_showcase').html('<tr><td><div id="nav_left_showcase"></div></td>');
    for(var i = 1; i<=pagination ; i++){
      $('#nav_showcase tr').append('<td><div class="pagination_showcase" id="dot_product_' + i + '"></div></td>')
    }
    $('#nav_showcase tr').append('<td><div id="nav_right_showcase"></div></td>');
  }),
  $('#button_products_oct').click(function(){
    ...
    /* DESCRIPTION */
    $('.content_showcase').html('<p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc.</p><p>This is Photoshop\'s version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. <br>Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.</p>');
    /* THE PAGINATION */
    $('#nav_showcase').html('<tr><td><div id="nav_left_showcase"></div></td>');
    for(var i = 1; i<=pagination ; i++){
      $('#nav_showcase tr').append('<td><div class="pagination_showcase" id="dot_product_' + i + '"></div></td>')
  ...
  $('#button_products_cpconseil').click(function(){
    ...
    var product = 'imac';
    var pagination = '3'; /* NUMBER OF SCREENSHOTS FOR PAGINATION */
...
;(function ($) {
  ...
  $.fn.showcase = function (startingOptions) {

    // Adds support for intializing multiple carousels from the same selector group
    if (this.length > 1) {
      this.each(function() {
        $(this).showcase(startingOptions);
      });
    ...
    function initializeCarouselData() {
      ...
      data.currentPagination.find('div').removeClass(options.activeClassPag);
    }
    ...
    function itemAnimationComplete($item, newPosition) {
      ...
      if (data.itemsAnimating === 0) {
        ...
        // Otherwise there are no more rotations and...
          ...
          var idCenter = $(".carousel-center").attr("id");

          $('#dot_'+ idCenter).addClass('current-pagination');
     ...
     */
    $('#nav_right_showcase').click(function(e) {
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('forward');
    });
    $('#nav_left_showcase').click(function(e) {
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('backward');
    });
     ...
     * Shadows
     */
    $('#shadow_right').click(function(e) {
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('forward');
    });
    $('#shadow_left').click(function(e) {
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('backward');
    });
    ...
    $$('#showcase').swipeLeft(function(){
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('forward');
    });
    $$('#product').swipeLeft(function(){
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('forward');
    });

    $$('#showcase').swipeRight(function(){
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('backward');
    });
    $$('#product').swipeRight(function(){
      autoPlay(true);
      options.autoPlay = 0;
      moveOnce('backward');
    });
    ...
    this.reload = function (newOptions) {
      ...
      options = $.extend({}, $.fn.showcase.defaults, newOptions);
  ...
  $.fn.showcase.defaults = {
    ...
    activeClassPag:             'current-pagination', // the name of the class given to the current item in the center
